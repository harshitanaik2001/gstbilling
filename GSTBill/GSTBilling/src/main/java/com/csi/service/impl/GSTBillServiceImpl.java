...
public class GSTBillServiceImpl implements GSTBillService {
    ...
    public String sendInvoiceToEmail(String invoiceId, MultipartFile file) throws IOException {
        ...
        try {
           ...
           /* MimeMessage is a class in the JavaMail API used to create and manipulate email messages in MIME (Multipurpose Internet Mail Extensions) format.
    ...
    @Override
    public List<GSTBill> searchByInvoiceDate(String invoiceDate) {
        return null;
    }
}